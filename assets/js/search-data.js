    ...
    handler: () => {
      window.location.href = "/academic/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "news-selected-for-the-shenzhen-peacock-talent-program-深圳市孔雀计划人才",
          title: 'Selected for the Shenzhen Peacock Talent Program (深圳市孔雀计划人才).',
          description: "",
          section: "News",},{id: "news-won-the-2nd-class-prize-of-the-academic-research-outstanding-award-in-nature-science-from-the-ministry-of-education-of-china-教育部自然科学二等奖-第-2-完成人",
          title: 'Won the 2nd Class Prize of the Academic Research Outstanding Award in Nature...',
          description: "",
          section: "News",},{id: "news-received-the-research-achievement-award-from-china-pacific-insurance-company",
          title: 'Received the Research Achievement Award from China Pacific Insurance Company.',
          description: "",
          section: "News",},{id: "news-received-the-best-practice-award-and-best-original-innovation-award-at-the-5th-national-smart-healthcare-and-medical-innovation-competition",
          title: 'Received the Best Practice Award and Best Original Innovation Award at The 5th...',
          description: "",
          section: "News",},{id: "news-won-the-1st-class-prize-of-the-shenzhen-natural-science-award-深圳市自然科学一等奖",
          title: 'Won the 1st Class Prize of the Shenzhen Natural Science Award (深圳市自然科学一等奖).',
          description: "",
          section: "News",},{id: "news-selected-as-a-best-paper-candidate-franklin-v-taylor-memorial-award-by-ieee-systems-man-and-cybernetics-society",
          title: 'Selected as a Best Paper Candidate (Franklin V. Taylor Memorial Award) by IEEE...',
          description: "",
          section: "News",},{id: "news-awarded-as-an-excellent-speaker-for-the-famous-teachers-enter-middle-schools-program-by-shenzhen-university",
          title: 'Awarded as an Excellent Speaker for the “Famous Teachers Enter Middle Schools” program...',
          description: "",
          section: "News",},{id: "news-won-the-first-class-prize-at-the-annual-conference-of-chinese-stomatological-association-中华口腔医学会-this-is-one-of-the-highest-awards-in-the-domestic-dental-field",
          title: 'Won the First Class Prize at the Annual Conference of Chinese Stomatological Association...',
          description: "",
          section: "News",},{id: "news-honored-with-the-outstanding-contribution-award-for-undergraduate-admission-by-shenzhen-university",
          title: 'Honored with the Outstanding Contribution Award for Undergraduate Admission by Shenzhen University.',
          description: "",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/1_project/";
            },},{id: "projects-project-2",
          title: 'project 2',
          description: "a project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/4_project/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/academic/projects/8_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=tiE0IDMAAAAJ", "_blank");
        },
      },{
